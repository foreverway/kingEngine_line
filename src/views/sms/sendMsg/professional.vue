...
export default class extends Vue {
  @Prop({ type: Array, default: [] }) professional !: any
  private tableData: any = this.$base.common.extend(this.professional)
  // 点击行数据
  private row: any = {}
  ...
  private commitProfessional() {
    let res = new Promise((resolve, reject) => {
      this.$emit('update:professional', this.tableData)
      resolve()
    })
    return res
  }
