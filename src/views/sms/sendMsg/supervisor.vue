...
export default class extends Vue {
  @Prop({ type: Array, default: [] }) supervisor !: any
  private tableData: any = this.$base.common.extend(this.supervisor)
  // 点击行数据
  private row: any = {}
  ...
  private commitSupervisor() {
    let res = new Promise((resolve, reject) => {
      this.$emit('update:supervisor', this.tableData)
      resolve()
    })
    return res
  }
